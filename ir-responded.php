...
<head>
    <meta charset="UTF-8">
    <title>Incident Report | Responded Report </title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    
    <link rel="stylesheet" href="ir-responded1.css">
...
$rno=$_GET['report_no'];
  ...
  $search="SELECT * from responded_report where(report_no='$rno')";
                  ...
                  <div class=details personal>
                     ...
                     closeImgBtn.addEventListener('click', () => {
                        ...
                        <div class=input-fields>
                            ...
                            <input type='date' value='$i' name='txtdateRes' readonly>
                        </div>

                        <div class=input-fields>
                            <label>Action Taken</label>
                            <input type='text' value='$j' name='txtAction' readonly>
                        </div> 
                        
                        <div class='choice-btn'>
                        <button name='btnBack' type='submit' class='cancel-btn'><a href=ir-report-rec.php>BACK</a></button>
                        <button name='btnView' type='submit' class='res-btn'><a href=ir-video-view1.php?report_no=$rno>VIEW</a></button>
        </div>
                        </div>";
    }
}
