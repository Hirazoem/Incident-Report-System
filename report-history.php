...
<head>
    <meta charset="UTF-8">
    <title> Incident Report | Report History </title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    
    <link rel="stylesheet" href="report-history.css">
...
$sql = "SELECT * from responded_report, stud_admin_rec WHERE(reported_by='$email' and email='$email')";
...
<div class='menu-items'>
    <ul class='nav-links'>
        ...
        <li><a href='report-history.php?email=$email'>
...
{
  print "<div class='result'><span class='r-msg'>NO REPORT/S RETRIVED.</span></div>";
}
}
}
