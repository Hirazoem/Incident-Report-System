...
<div class='dash-content'>
    ...
    <button type="submit" class="btn-print" name="export1">Print Table</button>
</form>

    <form action='ir-report-ignored.php' method='get' enctype='multipart/form-data'>
...
if(isset($_GET['from-date']) && isset($_GET['to-date'])) 
{
    ...
    $sql = "SELECT * FROM ignore_report WHERE date_ignored BETWEEN '$from_date' AND '$to_date'";
