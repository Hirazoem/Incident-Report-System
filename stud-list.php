...
<head>
    <meta charset="UTF-8">
    <title> Incident Report | Student List </title>
...
$sql = "SELECT * from stud_admin_rec WHERE status='Student'";
$result=mysqli_query($con,$sql);    
    ...
    while ($rec=mysqli_fetch_array($result,MYSQLI_ASSOC))
 {
  ...
  $d=$rec['yr_sec'];
    ...
    <td>$c</td>
    <td>$d</td>
    <td><button class='review'><a href=stud-acc.php?email=$a>View Account</a></td>
    </tr>";
